...
const ProjectPage: FC<ProjectPageProps> = ({ project }) => {
  ...
  return (
    ...
    <Head>
      ...
      <link rel="canonical" href={`https://www.starknet-ecosystem.com/projects/${project.id}`} />
      <meta property="og:url" content={`https://www.starknet-ecosystem.com/projects/${project.id}`} />
