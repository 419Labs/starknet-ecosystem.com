...
export const learning: Resource[] = [
 ...
 },
 {
    ...
    description:"Learn how to build StarkNet <-> Ethereum cross layer applications",
    tags:[
       "learn"
    ],
    network:{
 ...
 },
 {
    ...
    description:"A curated list of awesome Cairo resources, libraries, tools and more",
    tags:[
       "learn"
    ],
    network:{
 ...
 },
 {
    name:"basecamp",
    shortName:"basecamp",
    description:"So you've landed in a strange finite field. Only thing to do now is setup basecamp",
    tags:[
       "learn"
    ],
    network:{
 ...
 },
 {
    ...
    description:"Learn how to deploy and customize an ERC721 token on StarkNet",
    tags:[
       "learn"
    ],
    network:{
 ...
 },
 {
    ...
    network:{
       github:"https://github.com/419Labs/workshop-arf-dapp) - Workshop for starknetCC (nextjs x starknetjs x cairo"
    }
 },
 {
    name:"starkware-demo",
 ...
 },
 {
    ...
    description:"This repo shows the cairo equivalents of the solidity language patterns",
    tags:[
       "learn"
    ],
    network:{
 ...
 },
 {
    ...
    description:"Basic example of deploying and using starknet.js for basic wallet operations",
    tags:[
       "learn"
    ],
    network:{
 ...
 },
 {
    ...
    network:{
       github:"https://github.com/419Labs/starknet-cc-tdd) - TDD (Test Driven Development"
    }
 },
 {
    ...
    network:{
       github:"https://github.com/utkukoca/starknet-cairo-101-Turkish-translation"
    }
 },
 {
 ...
 },
 {
    ...
    description:"Illustrates the difference in gas costs when using a Uint256 and a felt based token on StarkNet",
    tags:[
       "learn"
    ],
    network:{
 ...
 },
 {
    ...
    description:"This repo demonstrates an important StarkNet concept with regard to transaction hashes and how they are processed by StarkNet Alpha v4.",
    tags:[
       "learn"
    ],
    network:{
 ...
 },
 {
    ...
    description:"A curated list of Cairo/StarkNet resources, libraries, tools, and more",
    tags:[
       "learn"
    ],
    network:{
...
export const tools: Resource[] = [
 ...
 },
 {
    name:"protostar",
    shortName:"protostar",
    description:"Protostar is a toolchain for developing and testing with Cairo contracts for StarkNet",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    ...
    description:"StarkNet dev stack focused on fast product iterations, inspired by scaffold-eth",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    ...
    network:{
       github:"https://github.com/software-mansion/starknet-jvm) - SDK for JVM languages (java, kotlin and others"
    }
 },
 {
    name:"Starkops",
 ...
 },
 {
    ...
    network:{
       github:"https://github.com/software-mansion-labs/starknet-web3-rpc-adapter"
    }
 },
 {
 ...
 },
 {
    ...
    description:"This plugin aims for having smart contracts which are written in Cairo to be compilied and then deployed.",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    ...
    description:"This is a repository for building and pushing Docker images required by Cairo tools.",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    ...
    description:"Example setup of a Starknet-Hardhat-TypeScript project. This is an empty project that you can take a fork. It's configured and works following the instructions.",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    name:"Zem",
    shortName:"zem",
    description:"A deployment system for Hardhat which supports EVM and StarkNet contracts",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    ...
    description:"Hardhat plugin which integrates StarkNet.js to allow deploying and interacting with StarkNet contracts from Hardhat projects",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    ...
    description:"FIFO stack,install hardhat, and understand how to write tests",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    ...
    network:{
       github:"https://github.com/socol-labs/simps.app) - Monorepo for StarkNet Improvement Projects (SIMPs"
    }
 },
 {
    name:"gaetbout/huffman-coding",
    shortName:"gaetbout/huffman-coding",
    description:"In this repository I'll try to implement the Huffman coding algorithm. This is a lossless compression algorithm.",
    tags:[
       "tools"
    ],
    network:{
 ...
 },
 {
    ...
    network:{
       github:"https://github.com/ctrlc03/stark-browniesh) - Interactive CLI wrapper for nile (OZ"
    }
 },
 {
 ...
 },
 {
    ...
    description:"Hardhat plugin for automatically and intelligently compiling StarkNet contracts",
    tags:[
       "tools"
    ],
    network:{
...
},
{
  ...
  description:"A library for bitwise integer types (e.g. int64 or uint32) in Cairo, with a test suite",
  tags:[
     "math",
     "tools"
  ],
  network:{
     github:"https://github.com/bellissimogiorno/cairo-integer-types) - A library for bitwise integer types (e.g. int64 or uint32"
  }
},
{
  name:"cairo-math",
...
},
{
  ...
  description:"Repository that defines a cairo struct called ratio that represents a rational number, x/y where x and y are in z mod p. Defines several operations between ratios.",
  tags:[
     "math",
     "tools"
  ],
...
},
{
  ...
  description:"Math of 384 bit numbers in pure cairo. Geared towards being used in ecc",
  tags:[
     "math",
     "tools"
  ],
...
},
{
  ...
  description:"A pseudorandom and procedural generation library using 64.61 fixed point math for Cairo",
  tags:[
     "math",
     "tools"
  ],
...
},
{
  name:"rpow",
  shortName:"rpow",
  description:"Cairo Implementation of fast exponentiation algorithm by MakerDAO",
  tags:[
     "math",
     "tools"
  ],
...
export const newsfeed: Resource[] = [
  {
    ...
    description:
      "Official weekly edu newsletter",
    tags: ["newsletter"],
    network: {
  ...
  },
  {
    ...
    description:
      "Official latest updates about StarkNet from StarkWare",
    tags: ["newsletter"],
    network: {
